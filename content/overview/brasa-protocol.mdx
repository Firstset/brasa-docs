...
- **Optimize yield** through Brasa's active delegation strategy
...
![Brasa liquid staking vs native staking comparison](/marketing/Brasa%20vs%20Native%20staking.png)
...
well-performing (APY-adjusted basis) validators in the network. This approach:
