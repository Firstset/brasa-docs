...
could exploit an edge case in the canonical SPL Stake Pool design that could
allow them to extract yield from the pool. For more technical details, see the
